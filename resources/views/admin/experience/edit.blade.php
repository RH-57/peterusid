...
<head>
  ...
  <title>Edit Experiences - Admin</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="index.html">Experiences</a></li>
            ...
            <div class="card-body pt-3">
                <form action="{{ route('experiences.update', $experience->id) }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="company" class="form-control" value="{{ old('company', $experience->company) }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="position" class="form-control" value="{{ old('position', $experience->position) }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <input type="number" name="start_year" class="form-control" value="{{ old('start_year', $experience->start_year) }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <input type="number" name="end_year" id="end_year" class="form-control" value="{{ old('end_year', $experience->end_year) }}" {{ old('is_present') ? 'disabled' : '' }}>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6 form-check">
                            ...
                            id="is_present"
                            value="1"
                            {{ old('is_present', $experience->is_present) ? 'checked' : '' }}
                            >
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="location" class="form-control" value="{{ old('location', $experience->location) }}">
                        </div>
                    </div>
