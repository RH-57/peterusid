...
<head>
  ...
  <title>Create Educations - Admin</title>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('educations.store') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-2">
                            <input type="number" name="start_year" class="form-control @error('start_year') is-invalid @enderror" value="{{ old('start_year') }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-2">
                            <input type="number" name="end_year" class="form-control @error('end_year') is-invalid @enderror" value="{{ old('end_year') }}">
